...
const defaultProducts = [
    {
        ...
        longDesc: "অর্ডার কনফার্ম হওয়ার ১০ মিনিটের মধ্যেই আপনার দেওয়া WhatsApp নম্বর অথবা ইমেইলে অ্যাকাউন্ট ডেলিভারি করা হবে। অ্যাকাউন্ট ব্যবহারে কোনো সমস্যা হলে আমাদের WhatsApp সাপোর্টে যোগাযোগ করুন — দ্রুত সমাধান দেওয়া হবে।",
        features: [
            "4K Ultra HD Quality",
    ...
    },
    {
        ...
        longDesc: "🎵 Spotify Premium (Family Invitation Method)\nআপনার পার্সোনাল জিমেইল-এ Spotify Family Invitation পাঠানো হবে।\nইনভিটেশন Accept করার পরই আপনার একাউন্টে Spotify Premium Active হয়ে যাবে।",
        features: [
    ...
    },
    {
        ...
        longDesc: "🎮 Free Fire 115 Diamonds\n💎 প্রিমিয়াম ইন-গেম কারেন্সি\n🚀 Player ID (UID) তে সরাসরি ডেলিভারি\n⏱ ৫–১০ মিনিটের মধ্যে ডায়মন্ড যুক্ত হবে",
        features: [
            "৫–১০ মিনিটের মধ্যে ডায়মন্ড যুক্ত হবে",
    ...
    },
    {
        ...
        longDesc: "🎮 PUBG Mobile 60 UC\n💎 প্রিমিয়াম ইন-গেম কারেন্সি (UC)\n🚀 Player ID তে সরাসরি ডেলিভারি\n⏱ ৫–১০ মিনিটের মধ্যে UC যুক্ত হবে",
        features: [
            "৫–১০ মিনিটের মধ্যে UC যুক্ত হবে",
    ...
    },
    {
        ...
        price: 300,
        originalPrice: 600,
        image: "images/Combo YT+Storage.png",
