        ...
        detailsSection.innerHTML = `
            <div class="text-center p-6 space-y-4 animate-fade-in">
                ...
                <div class="flex justify-center flex-wrap gap-4 mt-2">
                    ...
                    <img src="/assets/images/Nagad.png" alt="Nagad" class="h-10 object-contain bg-white rounded px-2 py-1">
                    <img src="/assets/images/Rocket.png" alt="Rocket" class="h-10 object-contain bg-white rounded px-2 py-1">
