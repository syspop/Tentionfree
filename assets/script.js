...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Expose necessary functions to window if not already (for inline HTML onclicks)
    // Most are already global due to separate file loading strategy (config, utils, etc)
});
